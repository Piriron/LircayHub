					  ...
					  <div class="panel panel-default arrow left">
						<div class="panel-body">
						  ...
						  <div class="text-right" id="button_section_<?php echo $post['post_id']; ?>">
							<a class="btn btn-default btn-sm" id="edit_<?php echo $post['post_id']; ?>"><i class="fa fa-reply"></i>Editar</a>
							<a class="btn btn-default btn-sm"><i class="fa fa-reply"></i>Eliminar</a>
						  </div>
						  
						
							
						<div id="editSection_<?php echo $post['post_id']; ?>" class="hidden">						
							<button type="submit" id="save_<?php echo $post['post_id']; ?>" name="save" class="btn btn-info saveButton">Guardar</button>
							<button type="submit" id="cancel_<?php echo $post['post_id']; ?>" name="cancel" class="btn btn-info saveButton">Cancelar</button>
						</div>					
						</div>					
	...
	<div id="postHtml" class="hidden">					
		<article class="row">
			<div class="col-md-2 col-sm-2 hidden-xs">
			  <figure class="thumbnail">
				<img class="img-responsive" src="images/user-avatar.png" />
				<figcaption class="text-center">Usuario</figcaption>
			  </figure>
			</div>
			<div class="col-md-10 col-sm-10">
			  <div class="panel panel-default arrow left">
				<div class="panel-body">
				  <header class="text-left">
					<div class="comment-user"><i class="fa fa-user"></i> De: USUARIO</div>
					<time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o"></i> <i class="fa fa-exchange" aria-hidden="true"></i></time>
				  </header>
				  <br>
				  ...
				  <div class="text-right" id="button_section_POSTID">
					<a class="btn btn-default btn-sm" id="edit_POSTID"><i class="fa fa-reply"></i>Editar</a>
					<a class="btn btn-default btn-sm"><i class="fa fa-reply"></i>Eliminar</a>
				  </div>
				  
				  <div id="editSection_POSTID" class="hidden">						
					<button type="submit" id="save_POSTID" name="save" class="btn btn-info saveButton">Guardar</button>
					<button type="submit" id="cancel_POSTID" name="cancel" class="btn btn-info saveButton">Eliminar</button>
				 </div>	
			...
			<div class="col-md-10 col-sm-10">
			  <div class="panel panel-default arrow left">
				<div class="panel-body">
				  <header class="text-left">
					<div class="comment-user"><i class="fa fa-user"></i> De: USUARIO</div>
					<time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o"></i> FECHA</time>
				  </header>
				  <br>
				  <div class="comment-post" id="post_message_POSTID">					
				  POST MENSAJE					
				  ...
				  <div id="editSection_POSTID" class="hidden">						
					<button type="submit" id="save_POSTID" name="save" class="btn btn-info saveButton">Guardar</button>
					<button type="submit" id="cancel_POSTID" name="cancel" class="btn btn-info saveButton">Cancelar</button>
				 </div>	
