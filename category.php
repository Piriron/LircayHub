	...
	<div class="row">
		...
		<?php if(empty($_GET['category_id'])) { ?>
			<div class="single category">			
				<ul class="list-unstyled">					
					<li><span style="font-size:25px;font-weight:bold;">Categorias</span> <span class="pull-right"><span style="font-size:20px;font-weight:bold;">Tema / Publicaciones</span></span></li>
					<?php
	   ...
	   <?php } else if(!empty($_GET['category_id'])) { ?>	   
		   <div class="single category">
				...
				<ul class="list-unstyled">
					<li class="text-right">
					<a type="button" class="btn btn-primary" href="compose.php?category_id=<?php echo $_GET['category_id'];?>"><span style="font-size:20px;font-weight:bold;color:white;">Crear nuevo tema</span></a>
					</li><br>
					<li><span style="font-size:20px;font-weight:bold;">Topics</span> <span class="pull-right"><span style="font-size:15px;font-weight:bold;">Publicaciones</span></span></li>
					<?php
